...
export const StyleOptions: CustomStyle[] = [
  {
    ...
    customCSS: {
      ...
      rules_UNSTABLE: {
        ...
        '[data-testid="spotter-search-bar"]': {
          background: DarkModeColors.primary,
          color: DarkModeColors.secondary,
        },
        '[data-testid="spotter-completions-dropdown"]': {
          background: DarkModeColors.primary,
          color: DarkModeColors.secondary,
        },
        ...
        '[class*="answerEditPane"], [class*="answerConfigPanelNav"]': {
          "border-left":
            "1px solid " + DarkModeColors.secondary + "11 !important",
        },
        '[class*="headerText"]': {
          color: DarkModeColors.secondary + " !important",
        },
  ...
  },
  {
    ...
    customCSS: {
      variables: {
        ...
        //@ts-ignore
        "--ts-var-spotter-bar-header-background-color": "transparent",
      },
      rules_UNSTABLE: {
  ...
  },
  {
    ...
    customCSS: {
      ...
      rules_UNSTABLE: {
        ...
        ".ag-header-viewport": {
          "border-bottom":
            "1px solid var(--ag-border-color,#eaedf2) !important",
        },
  ...
  },
  {
    ...
    customCSS: {
      ...
      rules_UNSTABLE: {
        ...
        ".conv-assist-answer-module__spotterTokensBar": {
          background: "#e6e7e8",
        },
